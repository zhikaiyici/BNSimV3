...
class BNSimRun : public G4Run
{
  public:
    ...
    void PushbackNeutronEnergy(G4double nenergy);

    // get methods
    inline std::list<G4double> GetEnergyDeposit() const { return energyDeposit; }
    inline std::list<G4double> GetNeutronEnergy() const { return neutronEnergy; }
  ...
  private:
    ...
    std::list<G4double> neutronEnergy;
};
